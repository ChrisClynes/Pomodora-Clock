            ...
            <div id="center-container">
                <div id="clock-container">
                    ...
                    <div className="timer-wrapper">
                        <div className="session-wrapper" id="timer-label">Session
                        <div id="time-left">{session}</div>
                            <div className="grid-wrapper">
                                <button id="session-play" className="btn btn-primary incrementLeft"><span className="fa fa-play fa-2x"></span></button>
                                <button id="session-pause" className="btn btn-primary incrementCenter"><span className="fa fa-pause fa-2x"></span></button>
                                <button id="reset" className="btn btn-primary incrementRight"><span className="fa fa-refresh fa-2x"></span></button>
                            </div>
                        </div>
                    </div>
